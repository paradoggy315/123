...
INSERT INTO `requests` VALUES (1,1,3,NULL,50,'Open','2024-02-14 03:27:20'),(2,1,3,NULL,20,'Open','2024-02-14 03:27:20');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddItem`(IN _name VARCHAR(255), IN _category VARCHAR(255), IN _description TEXT, IN _quantity INT, IN _donorID INT, IN _location VARCHAR(255))
BEGIN
